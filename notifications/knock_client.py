...
def trigger_notification(workflow_key: str, recipients: list, data: dict = None, actor=None):
    """
    ...
    actor: Optional user payload dictionary representing the actor who performed the action.
    """
    if data is None:
        data = {}
