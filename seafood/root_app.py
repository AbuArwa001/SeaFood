    ...
    return Response({
                    "message": "Welcome to the Seafood API",
                     ...
                     "URLS": {
                        ...
                        "logistics-receipts": f"{request.scheme}://{request.get_host()}/api/v1/logistics-receipts/",
                        "supplier-purchases": f"{request.scheme}://{request.get_host()}/api/v1/supplier_purchases/",
